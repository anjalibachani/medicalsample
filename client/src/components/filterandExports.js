	...
	render() {
		return (
            <div>
            	<Header/>
                {this.state.filters}
				<Button variant="dark" size="md" onClick={this.addFilter}>AddFilter</Button>
				<Button variant="dark" size="md" onClick={this.processFilter}>Filter</Button>
                <Button variant="dark" size="md" onClick={this.exportToCSV}>Export</Button>
                <Button variant="dark" size="md" onClick={this.exportToCSV}>ClearFilters</Button>
                <Button variant="dark" size="md" onClick={this.exportToCSV}>DeleteSample</Button>
				<hr />
				<Row>
                    <Col align="right">
